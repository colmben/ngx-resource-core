...
export interface IResourceMethodStrict<IB, IQ, IP, O> {
    (body: IB, query: IQ, params: IP, onSuccess?: (data: O) => any, onError?: (err: IResourceResponse) => any): Promise<O>;
    (body: IB, query: IQ, onSuccess?: (data: O) => any, onError?: (err: IResourceResponse) => any): Promise<O>;
    (body: IB, onSuccess?: (data: O) => any, onError?: (err: IResourceResponse) => any): Promise<O>;
    (onSuccess?: (data: O) => any, onError?: (err: IResourceResponse) => any): Promise<O>;
}
export interface IResourceMethodResultStrict<IB, IQ, IP, O> {
    (body: IB, query: IQ, params: IP, onSuccess?: (data: ResourceResult<O>) => any, onError?: (err: IResourceResponse) => any): ResourceResult<O>;
    (body: IB, query: IQ, onSuccess?: (data: ResourceResult<O>) => any, onError?: (err: IResourceResponse) => any): ResourceResult<O>;
    (body: IB, onSuccess?: (data: ResourceResult<O>) => any, onError?: (err: IResourceResponse) => any): ResourceResult<O>;
    (onSuccess?: (data: ResourceResult<O>) => any, onError?: (err: IResourceResponse) => any): ResourceResult<O>;
}
